...
function openerBank(creature: Creature, hunter: Hunter, kitId?: KitId): string[] {
  ...
  const banks: Record<string, string[]> = {
    ...
    'amber-silk': [
      ...
      `${creature.name}: ${name}, you're marked down until you earn otherwise. Earn the robe — or thrash pretty. I'm filing either way.`,
    ],
    veinrot: [
    ...
    'chrome-edge': [
      ...
      `${creature.name}: ${name}, those hands look sticky. Prove me wrong — or don't. Either way I fly.`,
    ],
    'the-choir': [
    ...
    grin: [
      ...
      `${creature.name}: ${name}, those hands look grabby. Be careful at the claim desk — or become inventory.`,
    ],
    'sister-static': [
    ...
    'pose-soft': [
      ...
      `${creature.name}: ${name}, you keep wiggling. Hold the pose — or freeze for real.`,
    ],
    oxidize: [
      ...
      `${creature.name}: ${name}, that armor is loud enough to season. Come careful — or rust.`,
    ],
    'iron-cadre': [
      ...
      `${creature.name}: ${name}, your ranks look broken. Fall in with the Cadre — or get corrected.`,
    ],
    'laugh-track': [
      ...
      `${creature.name}: ${name}, that was a cold open. Make us laugh for real — or bleed funny.`,
    ],
    'silt-knives': [
      ...
      `${creature.name}: ${name}, you smell like upstream litter. Step careful in the murk — or sink.`,
    ],
    'cinder-crew': [
      ...
      `${creature.name}: ${name}, you stay muted like a coward in the chat. Speak careful — or RSVP oxygen.`,
    ],
    'sting-grid': [
      ...
      `${creature.name}: ${name}, that neck is trespassing at our altitude. Duck careful — or get filed.`,
    ],
  };
