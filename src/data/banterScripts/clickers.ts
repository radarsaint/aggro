...
export const nodes: ScriptNode[] = [
  { id: 'clickers_open_x_0', beat: 'open', lines: [
    ...
    'Clickers: Neon nests remember who never tipped. Receipts you cannot read in the dark. Night shift overhead. Roof vents. Look up wrong.',
  ], weight: 2 },
  { id: 'clickers_open_x_1', beat: 'open', lines: [
    ...
    'Clickers: Volume. Horrible harmony. Graveyard-shift charm overhead. Click for service. Tip in blood if you are classy.',
  ], weight: 2 },
  ...
  { id: 'clickers_open_2', beat: 'open', lines: [
    'Clickers: Do not flinch first. Flinches ruin the service script. *click*',
  ...
  { id: 'clickers_hhit_bld_6', beat: 'hunter_hit', lines: [
    'Clickers: We are dripping mid-shift. You are still upright. One of those ends. *click*',
    'Clickers: Hurt and still pouring. That is night hospitality.',
  ...
  { id: 'clickers_hcrit_10', beat: 'hunter_crit', lines: [
    'Clickers: You found the hush-tip we do not put on the menu. Guest scores.',
  ...
  { id: 'clickers_kit_acid-vial_15', beat: 'kit', lines: [
    ...
    'Clickers: Acid mid-service. Guests who throw drinks do not get a second menu. *click*',
  ...
  { id: 'clickers_mhit_24', beat: 'monster_hit', lines: [
    'Clickers: That is for the unread tips and the scream you promised.',
    'Clickers: Bite landed. You asked for it. *click*',
  ] },
  { id: 'clickers_mhit_bld_25', beat: 'monster_hit', lines: [
    'Clickers: We are hurt. You are hurt more. Tip still theoretical. *click*',
  ...
  { id: 'clickers_mmiss_26', beat: 'monster_miss', lines: [
    ...
    'Clickers: Close call. Do not tip yourself on it.',
  ] },

  { id: 'clickers_w_wind_27', beat: 'wound', lines: [
    'Clickers: Nicked the soundtrack. Do not frame it.',
  ...
  { id: 'clickers_w_bld_29', beat: 'wound', lines: [
    'Clickers: Okay. We are dripping. Tip still theoretical.',
  ...
  { id: 'clickers_w_heart_30', beat: 'wound', lines: [
    ...
    'Clickers: Do not look at us like that while you are winning. Tips hate pity. *click*',
  ...
  { id: 'clickers_close_smoke_36', beat: 'close', lines: [
    'Clickers: Fog\'s cute. Does not matter. We hear you breathing — not looking.',
  ...
  { id: 'clickers_vic_crit_40', beat: 'victory', lines: [
    'Clickers: You cut through after-hours. Fight\'s over. We will give you that.',
