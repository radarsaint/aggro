...
export const nodes: ScriptNode[] = [
  ...
  { id: 'laugh-track_open_x_1', beat: 'open', lines: [
    'Laugh Track: The track does not do brave. We do fall, howl, bite. Cue howl. Bite on three.',
  ...
  { id: 'laugh-track_open_0', beat: 'open', lines: [
    ...
    'Laugh Track: Listen. We laugh. We bite. We laugh again. You brought a bag. Let us see who\'s the punchline.',
  ], weight: 2 },
  ...
  { id: 'laugh-track_open_2', beat: 'open', lines: [
    ...
    'Laugh Track: We have heard every hyena joke. Say something new or scream.',
  ], weight: 1 },
  ...
  { id: 'laugh-track_hmiss_7', beat: 'hunter_miss', lines: [
    'Laugh Track: Missed. Air does not get a cue.',
  ...
  { id: 'laugh-track_hcrit_10', beat: 'hunter_crit', lines: [
    ...
    'Laugh Track: Almost meant it. Do not chat. Swing.',
  ], weight: 2, setFlags: ["hunter_crit"] },
