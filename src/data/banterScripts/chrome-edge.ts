...
export const nodes: ScriptNode[] = [
  ...
  { id: 'chrome-edge_open_0', beat: 'open', lines: [
    'Chrome Edge: Warranty\'s a joke. First swing voids it. Second swing voids you. I am kidding. Mostly. Draw.',
    'Chrome Edge: Listen. I polish myself. I hover. I end arguments. You brought a bag and a face. Let us see which one of us is merchandise when this is over.',
  ], weight: 2 },
  ...
  { id: 'chrome-edge_hhit_bld_6', beat: 'hunter_hit', lines: [
    'Chrome Edge: You dinged me. I am still the best-looking thing in this fight.',
  ...
  { id: 'chrome-edge_def_crit_43', beat: 'defeat', lines: [
    ...
    'Chrome Edge: Big hit. Bad ending. I am still under the lights.',
  ], requireFlags: ["hunter_crit"], weight: 2 },
