...
export const nodes: ScriptNode[] = [
  { id: 'bleed-static_open_x_0', beat: 'open', lines: [
    'Bleed Static: Don\'t tense. Tension bruises the vintage. One sip. Then we talk about forever. Stay still.',
  ...
  { id: 'bleed-static_open_x_1', beat: 'open', lines: [
    'Bleed Static: Not thirsty — calibrated. Your unused PTO tastes like a first date you\'ll pretend was consensual. Shocking honesty: I will detach like an adult. After.',
    'Bleed Static: HR calls it benefits. I call it intimacy with a receipt. Don\'t swat mid-confession.',
  ], weight: 2 },
  ...
  { id: 'bleed-static_open_2', beat: 'open', lines: [
    'Bleed Static: Hold your breath. I\'m listening for the skip — the one you get when you lie about overtime.',
  ...
  { id: 'bleed-static_open_3', beat: 'open', lines: [
    ...
    'Bleed Static: I latch because the pulse asked first. Stay loud about it and I\'ll pretend we agreed.',
  ...
  { id: 'bleed-static_hhit_bld_6', beat: 'hunter_hit', lines: [
    'Bleed Static: Latch cracked. You\'re still warm. I\'m still listening.',
    'Bleed Static: Hurt and still attached. That\'s intimacy, darling.',
  ], requireFlags: ["wound:Bloodied"], weight: 3 },

  { id: 'bleed-static_hmiss_7', beat: 'hunter_miss', lines: [
    'Bleed Static: Missed. The air didn\'t deserve that swing.',
  ...
  { id: 'bleed-static_hcrit_ran_11', beat: 'hunter_crit', lines: [
    ...
    'Bleed Static: You ran from the latch then stabbed it. Mixed signals. Impressed and offended.',
  ...
  { id: 'bleed-static_kit_holy-water_16', beat: 'kit', lines: [
    'Bleed Static: Holy water. Cute. I\'m not undead. I\'m benefits.',
  ...
  { id: 'bleed-static_kit_net_19', beat: 'kit', lines: [
    'Bleed Static: You put a net on a sipper. That\'s not romance. That\'s rude.',
  ...
  { id: 'bleed-static_kit_gen_22', beat: 'kit', lines: [
    'Bleed Static: Rummaging won\'t save the vintage. I\'m on your neck.',
  ...
  { id: 'bleed-static_mhit_24', beat: 'monster_hit', lines: [
    'Bleed Static: That\'s for the unread messages and the PTO you never used.',
    'Bleed Static: Latch landed. You asked for it.',
  ] },
  { id: 'bleed-static_mhit_bld_25', beat: 'monster_hit', lines: [
    'Bleed Static: I\'m hurt. You\'re hurt more. Fair sip. Latch still warm.',
  ...
  { id: 'bleed-static_mmiss_26', beat: 'monster_miss', lines: [
    ...
    'Bleed Static: Close one. Don\'t write a love letter around a near-miss.',
  ] },

  { id: 'bleed-static_w_wind_27', beat: 'wound', lines: [
    'Bleed Static: Tiny nick on the drip. Don\'t get sentimental — that\'s my job.',
  ...
  { id: 'bleed-static_w_bru_28', beat: 'wound', lines: [
    ...
    'Bleed Static: Mid-sip damage. Persistent — like a skipped pulse that won\'t quit.',
  ], woundBand: 'Bruised', setFlags: ["wound:Bruised"] },
  { id: 'bleed-static_w_bld_29', beat: 'wound', lines: [
    'Bleed Static: Okay. Latch failing. You\'re still warm. I\'m still listening.',
  ...
  { id: 'bleed-static_w_heart_30', beat: 'wound', lines: [
    'Bleed Static: That one hit a soft place I was saving for later. Don\'t look at me like that.',
    'Bleed Static: Don\'t look at me like that while you\'re winning. It skips my pulse wrong.',
  ...
  { id: 'bleed-static_run_31', beat: 'run', lines: [
    ...
    'Bleed Static: Pull away mid-sip? The latch doesn\'t pause. Come back.',
  ...
  { id: 'bleed-static_chase2_34', beat: 'chase', lines: [
    ...
    'Bleed Static: Bolt again and I\'ll bill you for liking the latch.',
  ...
  { id: 'bleed-static_close_smoke_36', beat: 'close', lines: [
    'Bleed Static: Smoke won\'t hide a pulse. Still here. Still thirsty.',
  ...
  { id: 'bleed-static_vic_crit_40', beat: 'victory', lines: [
    'Bleed Static: You cut through the latch. Fight\'s over. I\'ll give you that.',
  ...
  { id: 'bleed-static_vic_net_41', beat: 'victory', lines: [
    ...
    'Bleed Static: Net, then win. You bagged a Benefits Vampire. I\'m not even mad. Okay, I\'m a little mad.',
