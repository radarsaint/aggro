...
export const nodes: ScriptNode[] = [
  ...
  { id: 'scale-crew_hcrit_ran_11', beat: 'hunter_crit', lines: [
    'Scale Crew: Ran from the plate then stabbed us. Mixed training notes. Sign the waiver again.',
  ...
  { id: 'scale-crew_kit_ran_23', beat: 'kit', lines: [
    'Scale Crew: You left the plate, then foraged like a trainee. Sign the waiver again. Boss!',
