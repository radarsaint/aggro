...
export const ITEM_DESCRIPTIONS: Record<string, string> = {
  ...
  'Belaying Hook': 'A boarding hook with tarred line still wrapped on the shank. Salt crusts the blade.',
  'Scuttle Lid': 'A hatch lid with one clean catch still working. SCUTTLE is scratched inside the rim.',
  'Tarred Vest': 'A tar-stiff vest that clings when it should let go. The smell never quite leaves.',
  'Blackwake Cleaver': 'A messy boarding cleaver with blackwake salt ground into the edge.',
  'Deadeye Arbalest': 'A quiet arbalest with a dark stock. The first bolt sits ready and unseen.',
  'No-Quarter Lid': 'A heavy lid stamped NO QUARTER on the inside. Leaving costs them.',
  'Rope-Burn Harness': 'Rigging straps that bite back. Rope-burn answers every hit.',
  'After-Watch Plating': 'After-Watch temper plating. One bruise gets one answer.',
