...
export const ITEM_DESCRIPTIONS: Record<string, string> = {
  ...
  'Soft-Close Lid': 'A steel cabinet door fitted with an inside grip. The dampers survived better than the cabinet it came from.',
  'Floor-Captain Vest': 'A supervisor’s vest with steel panels stitched over the ribs. Somebody finally gave it a use beyond identifying the supervisor.',
  'Final-Writeup Bow': 'A recurved bow with a leather grip and a red archive tag tied below it. The limbs have been kept carefully oiled.',
  'No-Refund Dome': 'A rounded steel cover fitted with leather straps. A repair plate reinforces the largest dent.',
  'After-Hours Plating': 'Steel plates riveted over a worn night-shift jacket. The old badge holder is still fastened to the chest.',
  'Belaying Hook': 'A heavy boarding hook with tarred cord around the grip. Salt has collected where the cord meets the steel.',
  'Scuttle Lid': 'An eight-sided hatch lid reinforced with iron bands. The brass catch still works, though it no longer has a ship to fasten to.',
  'Tarred Vest': 'A stiff leather vest sealed with tar and closed by heavy buckles. The rough stitching has held through years of damp.',
  'Blackwake Cleaver': 'A broad boarding blade with a cord-wrapped wooden grip. The cutting edge is polished bright beneath a crust of salt.',
  'Deadeye Arbalest': 'A heavy crossbow with a dark wooden stock and a brass winding mechanism. Rope protects the grip and the ends of the bow.',
  'No-Quarter Lid': 'A ship’s hatch reinforced with riveted iron straps. A faded skull remains on the boards beneath the scratches.',
  'Rope-Burn Harness': 'Thick hemp straps cross over fitted steel plates. Loose fibers catch on the buckles whenever the harness is adjusted.',
  'After-Watch Plating': 'Blue-black iron plates fastened over a sailor’s jacket. Salt has stiffened the cuffs, but the lining is still intact.',
